...
public class GrimPanModel {
	...
	public static final int EDIT_REMOVE = 6;
	public static final int SHAPE_Rectangle = 7;
	public static final int SHAPE_CURVE= 8;
	public static final int EDIT_ROTATE = 9;
